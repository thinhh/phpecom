    ...
    if(isset($_POST['scope'])) {
        ...
        switch($scope) {
            case "add":
                ...
                $check_query = "SELECT * FROM `carts` WHERE prod_id='$prod_id' AND user_id= $user_id";
            ...
            case "delete":
                ...
                $check_query = "SELECT * FROM `carts` WHERE id='$cart_id' AND user_id='$user_id'";
                $check_query_run = mysqli_query($con, $check_query);
                if(mysqli_num_rows($check_query_run) > 0) {
                    ...
                    echo "No items with matching record found in cart";
                }
                break;
